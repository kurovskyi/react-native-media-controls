...
export type Props = {
  ...
  mainControlsSize: number;
  secondaryControlsSize: number;
  secondaryControlsPadding: number;
...
const MediaControls = (props: Props) => {
  const {
    ...
    controlsColor = "#fff",
    mainControlsSize = 28,
    secondaryControlsSize = 16,
    secondaryControlsPadding = 20,
    onFullScreen,
  ...
  return (
    <TouchableWithoutFeedback accessible={false} onPress={toggleControls}>
      <Animated.View
        style={[
          styles.container,
          { paddingHorizontal: secondaryControlsPadding, opacity },
        ]}
      >
        {isVisible && (
          <View
          ...
          >
            ...
            <Controls
              ...
              mainControlsSize={mainControlsSize}
              secondaryControlsPadding={secondaryControlsPadding}
            ...
            <Slider
              ...
              mainColor={mainColor}
              controlsColor={controlsColor}
              secondaryControlsSize={secondaryControlsSize}
              secondaryControlsPadding={secondaryControlsPadding}
